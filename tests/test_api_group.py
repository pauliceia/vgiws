...
class TestAPIUserGroup(TestCase):
    ...
    def test_get_api_user_group_return_users_by_group_id(self):
        ...
        self.tester.api_user_group(expected, group_id="1003")
    ...
    @skip(">>>")
    def test_get_api_user_group_return_by_user_id_and_group_id(self):
        expected = {
            'type': 'FeatureCollection',
            'features': [
                {
        ...
        self.tester.api_user_group(expected, user_id="1001", group_id="1001")
    ...
    def test_get_api_user_group_create_and_delete(self):
        ...
        feature = self.tester.api_user_group_create(feature)

        # get the id of feature to REMOVE it
        feature_id = feature["properties"]["id"]

        # REMOVE THE group AFTER THE TESTS
        self.tester.api_user_group_delete(feature_id)
...
class TestAPIUserGroupErrors(TestCase):
    ...
    def test_delete_api_user_group_error_400_bad_request(self):
        ...
        self.tester.api_user_group_delete_error_400_bad_request("abc")
        self.tester.api_user_group_delete_error_400_bad_request(0)
        self.tester.api_user_group_delete_error_400_bad_request(-1)
        self.tester.api_user_group_delete_error_400_bad_request("-1")
        self.tester.api_user_group_delete_error_400_bad_request("0")
    ...
    def test_delete_api_user_group_error_403_forbidden(self):
        self.tester.api_user_group_delete_error_403_forbidden("abc")
        self.tester.api_user_group_delete_error_403_forbidden(0)
        self.tester.api_user_group_delete_error_403_forbidden(-1)
        self.tester.api_user_group_delete_error_403_forbidden("-1")
        self.tester.api_user_group_delete_error_403_forbidden("0")
        self.tester.api_user_group_delete_error_403_forbidden("1001")
    ...
    def test_delete_api_user_group_error_404_not_found(self):
        ...
        self.tester.api_user_group_delete_error_404_not_found("5000")
        self.tester.api_user_group_delete_error_404_not_found("5001")

...
CREATE TABLE IF NOT EXISTS `mydb`.`pauliceia_user` (
  ...
  `can_add_layer` TINYINT(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`layer` (
  ...
  INDEX `fk_layer_user_1_idx` (`user_id_published_by` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`changeset` (
  ...
  INDEX `fk_tb_project_tb_user1_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`notification` (
  ...
  `icon` TEXT NULL,
  `created_at` TIMESTAMP NOT NULL,
  `user_id` INT NULL COMMENT 'quem criou a notificação',
  `layer_id` INT NULL COMMENT 'O layer que a notificação está associada',
  `theme_id` INT NULL COMMENT 'O tema que a notificação está associada',
  `notification_id_parent` INT NULL,
  PRIMARY KEY (`notification_id`),
  INDEX `fk_notification_layer1_idx` (`layer_id` ASC),
  INDEX `fk_notification_theme1_idx` (`theme_id` ASC),
  INDEX `fk_notification_user_1_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`theme_followers` (
  ...
  INDEX `fk_user_follows_theme_theme1_idx` (`theme_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`reference_` (
  ...
  `bibtex` TEXT NULL COMMENT 'BibiText',
...
CREATE TABLE IF NOT EXISTS `mydb`.`curator` (
  ...
  INDEX `fk_curator_user_theme_theme1_idx` (`theme_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`layer_theme` (
  ...
  INDEX `fk_layer_theme_theme1_idx` (`theme_id` ASC),
...
-- -----------------------------------------------------
-- Table `mydb`.`reference_layer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`reference_layer` ;

CREATE TABLE IF NOT EXISTS `mydb`.`reference_layer` (
  `layer_id` INT NOT NULL,
  `reference_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_reference_layer_reference1`
    ...
    REFERENCES `mydb`.`reference_` (`reference_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`reference` (
  ...
  `layer_id` INT NOT NULL,
  PRIMARY KEY (`reference_id`),
  INDEX `fk_reference_layer1_idx` (`layer_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`time_columns` (
  `f_table_name` TEXT NOT NULL,
  `start_date_column` TEXT NULL,
  `end_date_column` TEXT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`media_columns` (
  ...
  `type` TEXT NULL,
  PRIMARY KEY (`f_table_name`, `column`))
ENGINE = InnoDB;

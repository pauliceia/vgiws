...
CREATE TABLE IF NOT EXISTS `mydb`.`project` (
  ...
  INDEX `fk_project_theme1_idx` (`fk_theme_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`notification` (
  ...
  INDEX `fk_notification_project1_idx` (`fk_project_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`bulk_import` (
  ...
  INDEX `fk_bulk_import_user_2_idx` (`fk_user_id_moderator` ASC),

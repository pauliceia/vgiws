...
from ..base import BaseHandlerNotification, BaseHandlerNotificationByFollower
...
class APINotificationByFollower(BaseHandlerNotificationByFollower):

    # A list of URLs that can be use for the HTTP methods
    urls = [r"/api/notification_by_follower/?(?P<param>[A-Za-z0-9-]+)?/",
            r"/api/notification_by_follower/?(?P<param>[A-Za-z0-9-]+)?"]
